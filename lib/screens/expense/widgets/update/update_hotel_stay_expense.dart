...
class UpdateHotelStayExpenseScreen extends StatefulWidget {
  UpdateHotelStayExpenseScreen({Key key, this.expenseListIndex, this.getExpenseProvider, this.id, this.expenseListId})
      : super(key: key);
  ...
  @override
  _UpdateHotelStayExpenseScreenState createState() => _UpdateHotelStayExpenseScreenState();
}

class _UpdateHotelStayExpenseScreenState extends State<UpdateHotelStayExpenseScreen> {
  ...
  getExpenseById() async {
    ...
    String noOfDaysCount =
        DateFormat("MM-dd-yyyy").parse(toDate).difference(DateFormat("MM-dd-yyyy").parse(fromDate)).inDays.toString();
    ...
    noOfDaysController.text = noOfDaysCount;
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    child: DropdownButton<int>(
                                      ...
                                      items:
                                      expenseDataProvider.expenseType.where((category) => category.catId == 6).map((categoryList) {
