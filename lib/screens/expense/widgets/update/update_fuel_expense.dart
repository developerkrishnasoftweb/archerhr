...
class UpdateFuelExpenseScreen extends StatefulWidget {
  UpdateFuelExpenseScreen({Key key,this.id,this.getExpenseProvider,this.expenseListIndex,this.expenseListId}) : super(key: key);
  ...
  @override
  _UpdateFuelExpenseScreenState createState() => _UpdateFuelExpenseScreenState();
}

class _UpdateFuelExpenseScreenState extends State<UpdateFuelExpenseScreen> {
  ...
  TextEditingController perKmMiController = TextEditingController();
  ...
  getExpenseById() async {
    ...
    String date = DateFormat("MM-dd-yyyy").format(DateFormat('dd-MM-yyyy').parse(getExpenseProvider.expenseList[widget.expenseListIndex].fromDt));
    //categoryDropdownValue = getExpenseProvider.expenseList[widget.expenseListIndex].catId;
    dateController.text = date;
    locationFromController.text = getExpenseProvider.expenseList[widget.expenseListIndex].fromPlace;
    locationToController.text = getExpenseProvider.expenseList[widget.expenseListIndex].toPlace;
    nameController.text = getExpenseProvider.expenseList[widget.expenseListIndex].expenseName;
    amountController.text = '${int.parse(getExpenseProvider.expenseList[widget.expenseListIndex].amount.toString().split(".")[0])}';
    perKmMiController.text = '${int.parse((getExpenseProvider.expenseList[widget.expenseListIndex].amount / getExpenseProvider.expenseList[widget.expenseListIndex].mileage).toString().split(".")[0])}' ;
    distanceController.text = '${int.parse(getExpenseProvider.expenseList[widget.expenseListIndex].mileage.toString().split(".")[0])}';
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child: DropdownButton<int>(
                                        ...
                                        items: expenseDataProvider.expenseType.where((category) => category.catId == 4).map((categoryList) {
                              ...
                              Expanded(
                                child: Column(
                                  children: [
                                    ...
                                    Input(
                                      controller: perKmMiController,
                                      keyboardType: TextInputType.number,
                                      onChanged: (value){
                                        amountController.text = ((int.tryParse(value) ?? 0) * (int.tryParse(distanceController.text) ?? 0)).toString();
                                      },
                                    ),
                                  ],
                                ),
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    Input(
                                      ...
                                      keyboardType: TextInputType.number,
                                      onChanged: (value){
                                        amountController.text = ((int.tryParse(perKmMiController.text) ?? 0) * (int.tryParse(value) ?? 0)).toString();
                                      },
                                    ),
                                  ],
                                ),
  ...
  _updateExpense() async {
    if (categoryDropdownValue != null &&
        ...
        locationFromController.text.isNotEmpty &&
        locationToController.text.isNotEmpty &&
      ...
      final expenseJson = {
        ...
        "FromPlace": locationFromController.text,
        "ToPlace": locationToController.text,
        "Mileage": distanceController.text,
