...
class UpdateOtherExpenseScreen extends StatefulWidget {
  UpdateOtherExpenseScreen({Key key, this.id, this.expenseListIndex, this.getExpenseProvider, this.expenseListId})
      : super(key: key);
  ...
  @override
  _UpdateOtherExpenseScreenState createState() => _UpdateOtherExpenseScreenState();
}

class _UpdateOtherExpenseScreenState extends State<UpdateOtherExpenseScreen> {
