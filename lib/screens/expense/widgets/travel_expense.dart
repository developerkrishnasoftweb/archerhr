...
class TravelExpenseScreen extends StatefulWidget {
  TravelExpenseScreen({Key key, this.id,this.expenseDataProvider, this.expenseListDataProvider}) : super(key: key);
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: DropdownButton<int>(
                          ...
                          items: expenseDataProvider.expenseType.where((category) => category.catId == 2).map((categoryList) {
