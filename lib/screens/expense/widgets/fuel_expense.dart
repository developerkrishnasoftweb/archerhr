...
class FuelExpenseScreen extends StatefulWidget {
  FuelExpenseScreen({Key key, this.id, this.expenseDataProvider, this.expenseListDataProvider}) : super(key: key);
                      ...
                      Input(
                        ...
                        onChanged: (value) {
                          amountController.text =
                              ((int.tryParse(value) ?? 0) * (int.tryParse(distanceController.text) ?? 0)).toString();
                        },
                      ),
                    ],
                  ),
                  ...
                  child: Column(
                    children: [
                      ...
                      Input(
                        ...
                        onChanged: (value) {
                          amountController.text =
                              ((int.tryParse(perKmMiController.text) ?? 0) * (int.tryParse(value) ?? 0)).toString();
                        },
                      ),
                    ],
                  ),
