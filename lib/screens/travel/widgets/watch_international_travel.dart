...
class WatchInternationalTravelScreen extends StatefulWidget {
  WatchInternationalTravelScreen({Key key,this.travelDataProvider,this.id}) : super(key: key);
  TravelDataProvider travelDataProvider;
  int id;

  @override
  _WatchInternationalTravelScreenState createState() => _WatchInternationalTravelScreenState();
}

class _WatchInternationalTravelScreenState extends State<WatchInternationalTravelScreen> {
                                        ...
                                        DropdownButton<int>(
                                          ...
                                          items: travelDataProvider.travelCountryList.map((countryList) {
                                            return DropdownMenuItem(
                                              child: Text(countryList.name,style: TextStyle(color: Colors.grey[800])),
