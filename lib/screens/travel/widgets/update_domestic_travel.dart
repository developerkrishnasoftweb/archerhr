...
class UpdateDomesticTravelScreen extends StatefulWidget {
  UpdateDomesticTravelScreen({Key key, this.id, this.travelDataProvider,this.travelListDataProvider}) : super(key: key);
  TravelDataProvider travelDataProvider;
  int id;
  TravelListDataProvider travelListDataProvider;

  @override
  _UpdateDomesticTravelScreenState createState() => _UpdateDomesticTravelScreenState();
}

class _UpdateDomesticTravelScreenState extends State<UpdateDomesticTravelScreen> {
  ...
  _updateTravel() async {
    if (travelDateController.text.isNotEmpty &&
      ...
      Utils.showToast("Please enter all details");
    }
  }
}
