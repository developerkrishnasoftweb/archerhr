...
class InternationalTravelScreen extends StatefulWidget {
  InternationalTravelScreen({Key key, this.travelDataProvider, this.travelListDataProvider}) : super(key: key);
  TravelListDataProvider travelListDataProvider;
  TravelDataProvider travelDataProvider;

  @override
  _InternationalTravelScreenState createState() => _InternationalTravelScreenState();
}
