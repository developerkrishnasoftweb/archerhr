                      ...
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            sizeBox10h,
                            Text(
                              provider.employeeDetail.firstName,
                              style: TextStyle(
                                fontSize: 16.sp,
                                fontWeight: FontWeight.w500,
                                color: Colors.white,
                              ...
                              switch (index) {
                                ...
                                case 1:
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => ProfessionDetailsProfileScreen(
                                        profileProvider: profileProvider
                                      ),
                                    ),
                                  );
                                ...
                                case 2:
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => AddressProfileScreen(
                                        profileProvider: profileProvider,
                                      ),
                                    ),
                                  );
                                ...
                                case 3:
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => EducationProfileScreen(
                                        profileProvider: profileProvider,
                                      ),
                                    ),
                                  );
                                ...
                                case 4:
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => ExperienceProfileScreen(
                                        profileProvider: profileProvider,
                                      ),
                                    ),
                                  );
                                ...
                                case 5:
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => SkillsProfileScreen(
                                        profileProvider: profileProvider,
                                      ),
                                    ),
                                  );
                                ...
                                case 6:
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => FamilyReferencesProfileScreen(
                                        profileProvider: profileProvider,
                                      ),
                                    ),
                                  );
                                ...
                                case 7:
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => StatutoryProfileScreen(
                                        profileProvider: profileProvider,
                                      ),
                                    ),
                                  );
                                ...
                                case 8:
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => BankProfileScreen(
                                        profileProvider: profileProvider,
                                      ),
                                    ),
                                  );
