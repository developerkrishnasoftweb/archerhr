...
class UpdateFullDay extends StatefulWidget {
  UpdateFullDay({Key key, this.leaveDataProvider, this.id}) : super(key: key);
  LeaveDataProvider leaveDataProvider;
  int id;

  @override
  _UpdateFullDayState createState() => _UpdateFullDayState();
}

class _UpdateFullDayState extends State<UpdateFullDay> {
